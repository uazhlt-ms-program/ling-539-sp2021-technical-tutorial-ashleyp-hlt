...
```
The last line in the code above simply removes the data points that were not labeled, as they are not useful for training a classifier. We have now created a functional training set without any hand labeling!
